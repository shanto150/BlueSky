...
<template>
  <div class="sidebar-wrapper">
    <div class="sidebar-header">
      ...
      <div class="mobile-toggle-icon ms-auto" @click="menuTaggle">
        <i class="bx bx-x"></i>
      </div>
    </div>
    <!--navigation-->
      ...
      <ul class="metismenu" id="menu">
        ...
        <li>
          ...
          <ul class="sub-menu" aria-expanded="true">
            <li>
              <a v-wave href="#" class="has-arrow"
                ><i class="bx bx-paper-plane"></i>Vertical</a
              >
              <ul class="sub-menu" aria-expanded="true">
                <li>
                  <a v-wave href="index.html"
                    ><i class="bx bx-paper-plane"></i>Infographic</a
                  >
                </li>
                <li>
                  <a v-wave href="index2.html"
                    ><i class="bx bx-paper-plane"></i>eCommerce</a
                  >
                </li>
                <li>
                  <a v-wave href="index3.html"
                    ><i class="bx bx-paper-plane"></i>Analytics</a
                  >
                </li>
              </ul>
            </li>
            <li>
              <a v-wave href="#" class="has-arrow"
                ><i class="bx bx-paper-plane"></i>Horizontal</a
              >
              <ul class="sub-menu" aria-expanded="true">
                <li>
                  <a v-wave href="layouts-horizontal.html"
                    ><i class="bx bx-paper-plane"></i>Horizontal</a
                  >
                </li>
                <li>
                  <a v-wave href="layouts-hori-topbar-dark.html"
                    ><i class="bx bx-paper-plane"></i>Topbar Dark</a
                  >
                </li>
                <li>
                  <a v-wave href="layouts-hori-boxed-width.html"
                    ><i class="bx bx-paper-plane"></i>Boxed Width</a
                  >
                </li>
              </ul>
            </li>
