                            ...
                            <table class="table table-sm table-striped table-bordered">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Agency: activate to sort column ascending"
                                            style="width: 116.087px;">Agency</th>

                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Payment Term: activate to sort column ascending"
                                            style="width: 107.037px;">Payment Term</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Bank & Balance: activate to sort column ascending"
                                            style="width: 107.037px;">Bank & Balance</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Ref. No: activate to sort column ascending"
                                            style="width: 107.037px;">Ref. No</th>

                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Total Amount: activate to sort column ascending"
                                            style="width: 107.037px;">Total Amount</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Attachments: activate to sort column ascending"
                                            style="width: 107.037px;">Attachments</th>

                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Remarks: activate to sort column ascending"
                                            style="width: 307.037px;">Remarks</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Requested By: activate to sort column ascending"
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3"><i class="bx bxs-circle me-1"></i>Approved </div>
                                        </td>
                                        <td>
                                            <button type="button" title="Log" style="size:30px;width:30px;height:30px;margin-left:5px;" class="btn btn-outline-action-log rounded-circle"><i class="fa-solid fa-arrow-trend-up" style="margin:2px 0px 10px -6px;font-size:14px;"></i></button>
                                        </td>
                                    </tr>

                                    <tr role="even" class="odd">
                                        ...
                                        <td>
                                            <div class="badge rounded-pill text-warning bg-light-warning p-2 text-uppercase px-3"><i class="bx bxs-circle me-1"></i>Requested </div>
                                        </td>
                                        <td>

                                            <router-link :to="{ name: 'depoDetails' }" style="size: 30px; width: 30px; height: 30px"
                                            ...
                                            <button type="button" title="Log" style="size:30px;width:30px;height:30px;margin-left:5px;" class="btn btn-outline-danger rounded-circle"><i class="fa fa-ban" style="margin:2px 0px 10px -5px;font-size:14px;"></i></button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr role="even" class="odd">
                                        ...
                                        <td>
                                            <div class="badge rounded-pill text-danger bg-light-danger p-2 text-uppercase px-3"><i class="bx bxs-circle me-1"></i>Rejected </div>
                                        </td>
                                        <td>
                                            <button type="button" title="Log" class="btn btn-outline-action-log rounded-circle" style="size: 30px; width: 30px; height: 30px; margin-left: 5px;"><i class="fa-solid fa-arrow-trend-up" style="margin: 2px 0px 10px -6px; font-size: 14px;"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
